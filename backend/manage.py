...
from app.models import User, Vehicle, Role, Data, roles_users, Alembic
...
def make_shell_context():
    return dict(app=app, db=db, User=User, Vehicle=Vehicle, Data=Data, Role=Role, roles_users=roles_users)

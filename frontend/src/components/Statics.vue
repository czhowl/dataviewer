<template>
   <div class="card" id="mapView">
       <div class="title"><i class="fa fa-table" aria-hidden="true"></i><span class="option-text">Statics</span><div class="corner-icon"><i class="fa fa-exchange option-icon" title="change view" aria-hidden="true" @click="$emit('switch')"></i>
